...
outfname = imageLocation.split("file:/")[1]+".json.gz"


import java.util.zip.GZIPOutputStream
FileOutputStream output = new FileOutputStream(outfname);
Writer writer = new OutputStreamWriter(new GZIPOutputStream(output), "ascii")
